...
class RecipeCard extends HTMLElement {
	...
	constructor() {
		...
		const shadow = this.attachShadow({mode: "open"});	// open mode attaches a new shadow DOM tree to a web component. Allows outside JaveScrip to access the shadow DOM if needed via element.shadowRoot
